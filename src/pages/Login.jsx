  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      <div className="mt-12 flex items-center justify-center gap-3">
        <a href="/privacy" className="text-xs text-gray-300 hover:text-gray-500 transition-colors">
          Privacyverklaring
        </a>
        <span className="text-xs text-gray-300">·</span>
        <a href="/disclaimer" className="text-xs text-gray-300 hover:text-gray-500 transition-colors">
          Disclaimer
        </a>
      </div>
