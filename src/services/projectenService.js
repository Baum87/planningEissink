...
export async function getProjecten({ metStats = false } = {}) {
  const select = metStats
    ? '*, toewijzingen(id, monteur_id, datum_van, datum_tot), projectleider:profielen!projectleider_id(id, afkorting, weergave_naam, avatar_kleur)'
    : '*, projectleider:profielen!projectleider_id(id, afkorting, weergave_naam, avatar_kleur)'
